...
public class MainActivity extends AppCompatActivity {
    ...
    private void obtenerInfo() {
        ...
        Toast.makeText(this, "Dato Numerico: "+numero, Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "Dato Pass: "+pass, Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "Dato Parrafo: "+parrafo, Toast.LENGTH_SHORT).show();
